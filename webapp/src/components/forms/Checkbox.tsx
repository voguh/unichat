...
export type CheckboxProps = ReplaceProps<"input", BsPrefixProps<"input"> & FormCheckProps> & FormGroupBaseProps;

const _logger = LoggerFactory.getLogger("Checkbox");
export const Checkbox = React.forwardRef<HTMLInputElement, CheckboxProps>(function Checkbox(props, ref) {
    ...
    return (
        <FormGroup
            ...
            {...dataProps}
        >
            <FormCheck {...rest} type="checkbox" ref={ref} />
        </FormGroup>
    );
});
