...
import { ComponentType, TextareaHTMLAttributes } from "preact";

import { styled } from "goober";
import tw from "twin.macro";

export const StyledTextarea: ComponentType<TextareaHTMLAttributes<HTMLTextAreaElement>> = styled.textarea({
