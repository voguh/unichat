...
async fn main() {
    ...
    tauri::Builder::default().setup(setup).on_window_event(on_window_event)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::userstore::userstore_get_items,
            commands::userstore::userstore_get_item,
            commands::userstore::userstore_set_items,
            commands::userstore::userstore_set_item,
